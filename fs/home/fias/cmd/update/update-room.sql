...
SET houseguid  = im.houseguid,
    regioncode = im.regioncode,
    flatnumber = im.flatnumber,
    flattype   = im.flattype,
    roomnumber = im.roomnumber,
    roomtype   = im.roomtype,
    cadnum     = im.cadnum,
    roomcadnum = im.roomcadnum,
...
from import.room01 im
         join fias.room01 fi
              on im.roomguid = fi.roomguid and im.roomid = fi.roomid
where im.roomguid = fa.roomguid
  and im.roomid = fa.roomid;
